      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {certificates.map((cert, idx) => (
            <div key={idx} className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-4 sm:p-5 transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent)]/50 hover:shadow-lg hover:shadow-black/30 active:-translate-y-1 active:border-[var(--accent)]/50 active:shadow-lg active:shadow-black/30">
