    ...
    <section id="contact" className="py-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <div className="flex items-center gap-3 mb-6 justify-center">
          <span className="font-mono text-(--accent-light) text-sm">06.</span>
          <h2 className="text-2xl lg:text-3xl font-bold text-(--text-primary)">İletişim</h2>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="flex items-center gap-3 px-6 py-3.5 bg-(--surface) border border-(--border) rounded-lg hover:border-(--accent)/60 transition-colors duration-300 w-full sm:w-auto"
          >
            ...
            <span className="text-sm text-(--text-primary) font-mono">{profile.email}</span>
          </a>
          ...
          >
            ...
            <span className="text-sm text-(--text-primary) font-mono">LinkedIn</span>
          </a>
        </div>

        <p className="text-xs text-(--text-muted) mt-10 font-mono">{profile.location}</p>
      </div>
    </section>
  )
}
