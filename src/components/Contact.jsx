    ...
    <section id="contact" className="py-16 sm:py-20 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href={`mailto:${profile.email}`} className="flex items-center gap-3 px-6 py-3.5 bg-[var(--surface)] border border-[var(--border)] rounded-lg hover:border-[var(--accent)]/60 active:border-[var(--accent)]/60 transition-colors duration-300 w-full sm:w-auto">
          ...
          <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-3.5 bg-[var(--surface)] border border-[var(--border)] rounded-lg hover:border-[var(--accent)]/60 active:border-[var(--accent)]/60 transition-colors duration-300 w-full sm:w-auto">
